defmodule SimpleRegistry do
  ...
  def registry(key) do
    ...
    # that a caller process is linked, eben though the registration fails. We can't simply unlink on a failing 
    ...
    # this is done here. For a proper implementation you can study the Registry codeafter
